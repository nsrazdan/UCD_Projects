function full_frame_queries()
    img1 = imread('frames\friends_0000003818.jpeg');
    img2 = imread('frames\friends_0000001535.jpeg');
    img3 = imread('frames\friends_0000000284.jpeg');

    kmeans = load('kMeans.mat');
    kmeans = kmeans.words;

    img1disc = load('sift\friends_0000003818.jpeg.mat', 'descriptors');
    img1disc = img1disc.descriptors;
    img2disc = load('sift\friends_0000001535.jpeg.mat', 'descriptors');
    img2disc = img2disc.descriptors;
    img3disc = load('sift\friends_0000000284.jpeg.mat', 'descriptors');
    img3disc = img3disc.descriptors;
